ASSIGNMENT 1 FOR COMP1921 
BY CHI FUNG HILLMAN CHAN

Assignment_1 folder contains: ASCIIfile folder for ASCII pgmfile, BinaryFile folder for binary pgmfile, Makefile, modules.txt,.c files x10, header files x8 , testplan.txt, testscript.sh

run function 

1.  Go To the assignment_1 directory to run the file.
